...
TARGET = me405project
OBJS = $(TARGET).o base_text_serial.o rs232.o motor_driver.o task_motor.o adc_driver.o controls.o stl_us_timer.o sharp_sensor_driver.o  solenoid.o task_solenoid.o task_sensor.o stl_task.o
